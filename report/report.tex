...
\newcommand{\benches}[1]{
  \begin{figure}[ht]
  \foreach \bench in
    {queue_pop,queue_push,queue_transfer,list_remove,list_real}
  {
    \begin{subfigure}{0.32\textwidth}
      \centering \footnotesize\code{\bench}
      \includegraphics[width=\textwidth]{plots/#1-b:\bench.pdf}
    \end{subfigure}
  }
