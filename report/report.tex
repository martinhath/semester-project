...
\todo{x86 only has CAS. it seems no arch has LL/SC 10/10 impl. But armv7 and 8
has something, so maybe we should try that? Or just say, rust doesn't support
it, and inline asm = :(, so future work?}
