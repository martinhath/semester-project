...
\begin{figure}[ht]
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \centering \footnotesize{\code{\scheme}}
      \includegraphics[width=\textwidth]{plots/laptop-s:\scheme-b:queue_push}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/laptop-s:\scheme-b:queue_pop}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/laptop-s:\scheme-b:queue_transfer}
    \end{subfigure}}
    \makebox[0.25\textwidth]{}
  \foreach \scheme in {ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/laptop-s:\scheme-b:list_remove}
    \end{subfigure}}
\end{figure}
...
\begin{figure}[ht]
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \centering \footnotesize{\code{\scheme}}
      \includegraphics[width=\textwidth]{plots/server-s:\scheme-b:queue_push}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/server-s:\scheme-b:queue_pop}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/server-s:\scheme-b:queue_transfer}
    \end{subfigure}}
    \makebox[0.25\textwidth]{}
  \foreach \scheme in {ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/server-s:\scheme-b:list_remove}
    \end{subfigure}}
    \caption{Results from the benchmark on the Queue.  Columns are reclamation
    schemes, and rows are benchmarks.  The columns are Crossbeam, EBR, HP, and
    HP-spin.  The rows are \code{Queue::push}, \code{Queue::pop}, and
    \code{Queue::transfer}.}
\end{figure}
...
\begin{figure}[ht]
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \centering \footnotesize{\code{\scheme}}
      \includegraphics[width=\textwidth]{plots/ryzen-s:\scheme-b:queue_push}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/ryzen-s:\scheme-b:queue_pop}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/ryzen-s:\scheme-b:queue_transfer}
    \end{subfigure}}
    \makebox[0.25\textwidth]{}
  \foreach \scheme in {ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/ryzen-s:\scheme-b:list_remove}
    \end{subfigure}}
    \caption{Results from the benchmark on the Queue.  Columns are reclamation
    schemes, and rows are benchmarks.  The columns are Crossbeam, EBR, HP, and
    HP-spin.  The rows are \code{Queue::push}, \code{Queue::pop}, and
...
\begin{figure}[ht]
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \centering \footnotesize{\code{\scheme}}
      \includegraphics[width=\textwidth]{plots/scaleway-s:\scheme-b:queue_push}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/scaleway-s:\scheme-b:queue_pop}
    \end{subfigure}}
  \foreach \scheme in {crossbeam, ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/scaleway-s:\scheme-b:queue_transfer}
    \end{subfigure}}
    \makebox[0.25\textwidth]{}
  \foreach \scheme in {ebr, hp, hpspin} {%
    \begin{subfigure}{0.25\textwidth}
      \includegraphics[width=\textwidth]{plots/scaleway-s:\scheme-b:list_remove}
    \end{subfigure}}
    \caption{Results from the benchmark on the Queue.  Columns are reclamation
    schemes, and rows are benchmarks.  The columns are Crossbeam, EBR, HP, and
    HP-spin.  The rows are \code{Queue::push}, \code{Queue::pop}, and
