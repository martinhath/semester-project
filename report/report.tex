...
to 48. \todo{Double check numbers here.} The CPUs we have tested on are a
...
We stress that the y-axis may differ wildly on the benchmarks.
...
\newcommand{\benches}[1]{
  \begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Benchmarks relative to no memoryreclamation for \code{#1}}
  \end{figure}
}
...
\begin{figure}[ht]
  ...
  % TODO: move this into \figuregrid
    \rotatebox{90}{\hspace{-0.6cm}\footnotesize{\code{List::remove}}}
    \begin{subfigure}{0.20\textwidth}
      \includegraphics[width=\textwidth]{plots/ryzen-s:nothing-b:list_remove}
    \end{subfigure}
  ...
  \foreach \scheme in {ebr, hp, hpspin} {%
    ...
    \begin{subfigure}{0.20\textwidth}
      \includegraphics[width=\textwidth]{plots/ryzen-s:nothing-b:list_real}
    \end{subfigure}
  \makebox[0.20\textwidth]{}
  \foreach \scheme in {ebr, hp, hpspin} {%
    \begin{subfigure}{0.20\textwidth}
      \includegraphics[width=\textwidth]{plots/ryzen-s:\scheme-b:list_real}
    \end{subfigure}}
