...
\note{How did we implement ebr? Trade-offs}
...
collected, and that we use EBR itself on them. This poses a problem: for each
...
lowers synchronization overhead, since less elements are shared between threads.
