...
\tikzset{node distance = 2.5cm, auto, lnode/.style={rectangle split, rectangle
split horizontal, rectangle split parts=2, draw, rounded corners=0.05cm }}
...
% keepspaces=true,              % keeps spaces in text, useful for keeping indentation of code (possibly needs columns=flexible)
 ...
 keywords={let,mut,fn,return,pub,struct,where,impl,as,match},
